...
export const Question: FC<QuestionProps> = ({
  ...
  return (
    ...
    >
      <h3 className="text-neutral-700 dark:text-white group-hover:text-black dark:group-hover:text-white font-medium transition-colors duration-200 text-lg sm:text-xl">
        {question.question}
      </h3>
      <p className="text-base text-neutral-500 dark:text-[#d4d4d4] mt-2">
